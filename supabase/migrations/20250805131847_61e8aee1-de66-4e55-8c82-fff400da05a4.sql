...
-- Update all existing user profiles to have 1 million resources
-- Since resources are currently stored in the GameContext (client-side), 
-- we need to create a user_resources table to persist resources in the database

-- First, create a user_resources table to store resources persistently
